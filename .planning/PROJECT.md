...
## Current Milestone: (planning next — v1.1 shipped 2026-07-17)

**Last shipped:** v1.1 "AI Destekli Lüks Deneyim" — AI capabilities layered over the luxury storefront (vehicle matcher, streaming configurator assistant, grounded support/order helper, admin content generator) with server-only keys, graceful degradation, code-sourced pricing, admin isolation, KVKK minimization, and a golden-eval harness — all additive over the Convex commerce backbone.
...
---
*Last updated: 2026-07-17 — milestone v1.1 shipped (Phases 5-8 complete)*
