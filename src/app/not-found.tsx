  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center px-4 py-24 text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        ...
        <Link
          href="/urunler"
          className="rounded-full border border-neutral-600 px-7 py-3.5 text-sm font-bold uppercase tracking-wide text-neutral-300 hover:border-brand-red hover:text-brand-red"
        >
          Ürünleri İncele
        </Link>
      </div>
