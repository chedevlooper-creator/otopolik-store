...
export default function SpecsBanner() {
  return (
    <section className="mx-auto max-w-5xl px-4 py-16 sm:py-20">
      <ScrollReveal>
        <div className="relative aspect-square overflow-hidden rounded-3xl border border-neutral-200 shadow-2xl shadow-black/10 ring-1 ring-black/5 sm:aspect-[16/10]">
          <Image
