    ...
    <section className="home-section relative overflow-hidden border-t border-white/[0.04]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 lg:grid-cols-[1.05fr_.95fr] lg:gap-16">
        <div>
          ...
          <h2
            className={`section-title ${
              header?.eyebrow && header.eyebrow.toUpperCase() !== "EYEBROW" ? "mt-6" : ""
            }`}
          >
          ...
          <div className="mt-10 space-y-2">
            {items.map((faq) => (
              <details
                key={faq.q}
                className="mac-glass group overflow-hidden rounded-2xl transition-all duration-300 open:border-white/[0.16]"
              >
        ...
        <div className="lg:pt-8">
          <div className="mac-glass sticky top-28 overflow-hidden rounded-2xl p-7 sm:p-8">
